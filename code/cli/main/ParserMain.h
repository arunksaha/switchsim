...
class ParseNode {
 public:
  ParseNode(string const& t, string const& h) : token_(t), helpString_(h) {}

  ParseNode() : token_("ERROR"), helpString_("ERROR") {}
  ...
  string tokenString() const { return token_; }

  string helpString() const { return helpString_; }
