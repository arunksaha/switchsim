...
void ConfigParserHandler::modifyPortN(PortId pId) const {
  // cout << " -> " << __PRETTY_FUNCTION__ << ", arg = " << pId << endl;
}

bool ConfigParserHandler::validPortId(PortId pId) const {
  // cout << " -> " << __PRETTY_FUNCTION__ << ", arg = " << pId << endl;
...
ParserMain* ConfigParserHandler::parserMain() const {
